---
title: 03-Kapcitor配置文件-A-配置文件简介
categories:
  - - 培训教程
    - TICK技术栈之kapacitor
tags:
...
<!-- MDTOC maxdepth:3 firsth1:1 numbering:0 flatten:0 bullets:1 updateOnSave:1 -->
   ...
   - [Example: An InfluxDB connection grouping](#example-an-influxdb-connection-grouping)   
      - [Kapacitor environment variables](#kapacitor-environment-variables)   
        - [Environment variables not in configuration file](#environment-variables-not-in-configuration-file)   
        - [Mapping properties to environment variables](#mapping-properties-to-environment-variables)   
...
[Configuring Kapacitor](https://docs.influxdata.com/kapacitor/v1.5/administration/configuration/)
