...
| 工作项               | 步骤               | 负责人 | 协助人 | 进度 | 月 日 | 月 日 | 月日 |
| -------------------- | ------------------ | ------ | ------ | ---- | ----- | ----- | ---- |
| 周一                 | 周二               | 周三   |        |      |       |       |      |
| xxx客户数据库归档    | 发送归档明细需求表 |        |        |      |       |       |      |
| 归档明细需求表反馈   |                    |        |        |      |       |       |      |
| 按照需求编写脚本测试 |                    |        |        |      |       |       |      |
| 申请测试环境         |                    |        |        |      |       |       |      |
| 脚本部署并测试       |                    |        |        |      |       |       |      |
...
| 序号 | 表名 | 是否有主键 | 归档维度 | 归档要求 | 归档表名规则 | 是否放置新实例 | 备注 |
| ---- | ---- | ---------- | -------- | -------- | ------------ | -------------- | ---- |
|      |      |            |          |          |              |                |      |
|      |      |            |          |          |              |                |      |
|      |      |            |          |          |              |                |      |
...
> 注意数据库对应的[PT工具的版本](/database/mysql/awesome-tools/percona_tookit.html)
>
