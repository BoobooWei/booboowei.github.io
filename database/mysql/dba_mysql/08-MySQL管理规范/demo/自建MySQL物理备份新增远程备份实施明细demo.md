---
title: 自建MySQL物理备份新增远程备份实施明细demo
---

# 备份服务器

- 新建备份存放目录`/alidata/backup/`
- 新建备份用户`mysqlbackup`密码`mysqlbackup`
- 新建备份过期脚本`/alidata/script/clean_backup.sh`
- 设置`crontab`每日3点59分开始清理30天之前的备份
...
4. 发送备份文件至备份服务器通过`scp`实现（*配置了无密钥登陆`mysqlbackup@192.168.20.3`*）
